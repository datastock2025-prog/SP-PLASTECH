...
// Extract all lines from pages 1 to 30 of Document RAPM1101A01T01
const rawPagesData = [
  // Page 1
  { group: "General", items: [
...
// Helper to determine supplier mapping from category / group
...
console.log("Building complete live supplier price lists catalog from PDF RAPM1101A01T01...");
