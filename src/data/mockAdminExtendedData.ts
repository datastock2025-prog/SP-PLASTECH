...
export const mockMasterDataRecords: MasterDataRecord[] = [
  {
    ...
    status: 'Approved',
    resinType: 'Polypropylene (PP)',
    color: 'Natural / Milky White',
    polymerGrade: 'Copolymer MFI 12 (Repol H110MA)',
    mfi: '12.0',
    density: '0.905',
  },
  {
    ...
    itemGroup: 'Colorants & Additives',
    plantScope: 'Pune / Chakan Hub',
    lastUpdated: '2026-08-28',
    updatedBy: 'Vikramaditya Sen',
    complianceCert: 'Automotive Weatherability SAE J2527',
    status: 'Approved',
    resinType: 'Universal Carrier / PP',
    color: 'Carbon Black (RAL 9005)',
    polymerGrade: 'High Dispersion Masterbatch',
    mfi: '15.0',
    density: '1.150',
  },
  {
    ...
    itemGroup: 'Automotive Assemblies',
    plantScope: 'Pune / Chakan Hub',
    lastUpdated: '2026-09-01',
    updatedBy: 'Priya Rao',
    complianceCert: 'PPAP Level-3 Approved',
    status: 'Approved',
    resinType: 'Impact Copolymer PP + 15% EPDM',
    color: 'Midnight Black / Painted Gloss',
    polymerGrade: 'Automotive Grade Auto-Prime',
    mfi: '18.5',
    density: '0.920',
  },
  {
    ...
    entityType: 'Finished Molded Component',
    code: 'FG-BEZEL-AC-4C',
    name: 'HVAC Air Vent Bezel Cluster (4-Cavity Precision Tooling)',
    primaryUom: 'Numbers (PCS)',
    category: 'Molded Automotive Parts',
    itemGroup: 'Interior Trim Components',
    plantScope: 'All Plants (Global)',
    lastUpdated: '2026-09-10',
    updatedBy: 'Dr. Sunita Kulkarni',
    complianceCert: 'IATF 16949, RoHS Compliant',
    status: 'Approved',
    resinType: 'ABS High Heat Resistant',
    color: 'Piano Black Gloss',
    polymerGrade: 'LG Chem Lupos HI-121',
    mfi: '22.0',
    density: '1.050',
  },
  {
    id: 'MD-05',
    entityType: 'Finished Molded Component',
    code: 'FG-DOOR-TRIM-LH',
    name: 'Door Inner Trim Panel LH (Tata Harrier / Safari)',
    primaryUom: 'Numbers (PCS)',
    category: 'Automotive Exterior',
    itemGroup: 'Door Assembly Sub-Systems',
    plantScope: 'Pune / Chakan Hub',
    lastUpdated: '2026-09-12',
    updatedBy: 'Priya Rao',
    complianceCert: 'PPAP Level-3 Approved, OEM Approved',
    status: 'Approved',
    resinType: 'Polypropylene Talc 20% Filled (PP-TD20)',
    color: 'Slate Grey Textured',
    polymerGrade: 'Borealis Daplen EE188HP',
    mfi: '14.0',
    density: '1.040',
  },
  {
    ...
    entityType: 'Polymer Resin Item',
    code: 'RES-HD-BLOW-01',
    name: 'High Density Polyethylene (HDPE Blow Grade MFI 0.3)',
    primaryUom: 'Kilograms (KG)',
    category: 'HDPE Blow Grade',
    itemGroup: 'Polymer Feedstock',
    plantScope: 'All Plants (Global)',
    lastUpdated: '2026-08-15',
    updatedBy: 'Dr. Sunita Kulkarni',
    complianceCert: 'FDA 21 CFR 177.1520, RoHS',
    status: 'Approved',
    resinType: 'HDPE High Molecular Weight',
    color: 'Natural Translucent',
    polymerGrade: 'IOCL 003DF35',
    mfi: '0.35',
    density: '0.952',
  },
  {
    ...
    entityType: 'Color Masterbatch',
    code: 'MB-RED-AUTO-01',
    name: 'Automotive Bright Crimson Red Masterbatch (30% Organic Pigment)',
    primaryUom: 'Kilograms (KG)',
    ...
    updatedBy: 'Vikramaditya Sen',
    complianceCert: 'RoHS, Non-Toxic, Heat Stable 280C',
    status: 'Approved',
    resinType: 'PP Carrier High Flow',
    color: 'Crimson Red (RAL 3002)',
    polymerGrade: 'Plastiblends AutoRed-X',
    mfi: '25.0',
    density: '1.180',
  },
  {
    ...
    itemGroup: 'Tooling & Mold Spares',
    plantScope: 'Pune / Chakan Hub',
    lastUpdated: '2026-07-15',
    updatedBy: 'Kailash Deshmukh',
    complianceCert: 'Mold Life Guarantee 500k Shots',
    status: 'Approved',
    resinType: 'P20 Steel Hardened',
    color: 'Metallic Polish',
    polymerGrade: 'DIN 1.2311 Tool Steel',
    mfi: 'N/A',
    density: '7.850',
  },
  {
