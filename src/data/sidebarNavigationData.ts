...
export const NAVIGATION_GROUPS: NavGroupDef[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'nav-reconciliation', label: 'Demand Reconciliation', view: 'monthlyReconciliation', icon: 'Layers', subGroup: 'Sales' },
      { id: 'nav-sales-deliveries', label: 'Deliveries & Dispatch', view: 'deliverySchedule', icon: 'Truck', badge: 'GST/EWB', badgeColor: 'bg-emerald-600', subGroup: 'Sales' },
      { id: 'nav-gate-pass', label: 'Security Gate Pass', view: 'gatePass', icon: 'ShieldCheck', subGroup: 'Sales' },
      { id: 'nav-ewb-einv', label: 'E-Way Bill & E-Invoice', view: 'eWayBillMgmt', icon: 'FileCheck', subGroup: 'Sales' },
      { id: 'nav-compliance-exc', label: 'Compliance Exceptions', view: 'complianceDashboard', icon: 'AlertTriangle', badge: '3 Blockers', badgeColor: 'bg-rose-600', subGroup: 'Sales' },
