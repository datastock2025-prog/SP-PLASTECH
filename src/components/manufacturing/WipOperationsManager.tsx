      ...
      <div className="bg-white border border-[#E4E0D6] rounded-2xl p-6 shadow-xs">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <button
              type="button"
              onClick={() => onNavigate('wipStoreQc')}
              className="px-4 py-2 rounded-xl text-xs font-bold bg-indigo-600 text-white hover:bg-indigo-700 shadow-sm flex items-center gap-2 transition-all transform hover:-translate-y-0.5"
            >
