    ...
    >
      ...
      <div className="flex items-center gap-1.5 sm:gap-2 min-w-0 shrink">
        ...
        <button
          ...
          className="p-1.5 sm:p-2 rounded-lg text-slate-600 hover:text-slate-900 hover:bg-slate-100 transition-colors cursor-pointer shrink-0"
        ...
        <div className="relative shrink-0">
          <button
            ...
            className="flex items-center gap-1.5 sm:gap-2 px-2 sm:px-2.5 py-1.5 rounded-xl border border-slate-200 bg-slate-50 hover:bg-slate-100/90 text-left transition-all cursor-pointer shadow-2xs group"
          ...
          >
            ...
            {/* Mobile compact plant code */}
            <span className="font-mono text-[10px] font-bold bg-[#14213D] text-white px-1.5 py-0.5 rounded md:hidden">
              {currentEntity.code}
            </span>
            <div className="hidden md:block">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-xs font-bold text-slate-800 truncate max-w-[110px] xl:max-w-[170px]">
                  {currentEntity.name.split(':')[1] || currentEntity.name}
                </span>
              </div>
              <div className="text-[10px] text-slate-500 truncate flex items-center gap-1">
                <span className="truncate max-w-[90px] xl:max-w-[140px]">{currentEntity.location}</span>
          ...
          {/* Plant Dropdown Menu */}
          {showPlantDropdown && (
            <div className="absolute left-0 top-full mt-2 w-[calc(100vw-24px)] max-w-sm sm:w-96 bg-white border border-slate-200 rounded-2xl shadow-2xl p-3 z-50 animate-in fade-in zoom-in-95 duration-150">
      ...
      >
        ...
        <span className="text-xs text-slate-400 truncate flex-1 font-medium">
          Search orders, items, machines...
        </span>
        <kbd className="hidden lg:inline-flex items-center gap-1 font-mono text-[10px] bg-white border border-[#E4E0D6] px-1.5 py-0.5 rounded-md text-[#6B7280] shadow-2xs font-bold shrink-0">
          Ctrl K
        </kbd>
      </div>
      ...
      <div className="flex items-center gap-1 sm:gap-1.5 shrink-0">
        ...
        <div className="relative">
          ...
          {showQuickActionsDropdown && (
            <div className="absolute right-0 top-full mt-2 w-[calc(100vw-20px)] max-w-sm sm:w-96 bg-white border border-slate-200 rounded-2xl shadow-2xl p-3 z-50 animate-in fade-in zoom-in-95 duration-150">
        ...
        <div className="relative hidden sm:block">
          ...
          {showHelpDropdown && (
            <div className="absolute right-0 top-full mt-2 w-[calc(100vw-20px)] max-w-xs sm:w-72 bg-white border border-slate-200 rounded-2xl shadow-2xl p-2.5 z-50 animate-in fade-in zoom-in-95 duration-150">
        ...
        <div className="relative hidden md:block">
          <button
            ...
            className="flex items-center gap-1 px-2 py-1.5 rounded-xl border border-slate-200 bg-slate-50 hover:bg-slate-100 text-xs font-bold text-slate-700 cursor-pointer shadow-2xs"
        ...
        <div className="relative">
          ...
          {showUserMenu && (
            <div className="absolute right-0 top-full mt-2 w-[calc(100vw-20px)] max-w-sm sm:w-80 bg-white border border-slate-200 rounded-2xl shadow-2xl p-3 z-50 animate-in fade-in zoom-in-95 duration-150">
              ...
              <div className="space-y-0.5 text-xs text-slate-700">
                ...
                {/* Mobile-only Quick Theme & Help shortcuts */}
                <div className="sm:hidden pt-2 pb-1 border-t border-slate-100 my-1">
                  ...
                  <div className="grid grid-cols-2 gap-1.5 px-1 pt-1">
                    <button
                      type="button"
                      onClick={() => {
                        setActiveTheme((prev) => (prev === 'light' ? 'dark' : prev === 'dark' ? 'high_contrast' : 'light'));
                        showToast('Switched theme');
                      }}
                      className="flex items-center justify-center gap-1.5 px-2 py-1.5 rounded-lg bg-slate-50 hover:bg-slate-100 border border-slate-200 text-xs font-semibold text-slate-700"
                    >
                    ...
                    <button
                      ...
                      className="flex items-center justify-center gap-1.5 px-2 py-1.5 rounded-lg bg-slate-50 hover:bg-slate-100 border border-slate-200 text-xs font-semibold text-slate-700"
                    >
                      <LifeBuoy className="w-3.5 h-3.5 text-[#0F8B8D]" />
                      <span>Help</span>
                    </button>
                  </div>
                </div>
