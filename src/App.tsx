...
export const getScreenTitle = (view: string, params: any = {}): string => {
  const titles: Record<string, string> = {
    ...
    soList: 'Sales Orders',
    soDashboard: 'Sales Order Command Center',
    soWizard: 'Create Sales Order Wizard',
    monthlyPlanOrders: 'Monthly Plan Orders',
    dailyQuickEntry: 'Daily Order Quick Entry',
    monthlyReconciliation: 'Demand Reconciliation',
    deliverySchedule: 'Deliveries & Dispatch',
    deliveryChallans: 'Delivery Notes & Challans',
    createChallan: 'Create Delivery Challan',
    gatePass: 'Security Gate Pass Verification',
    eWayBillMgmt: 'E-Way Bill & E-Invoice',
    complianceDashboard: 'Compliance Exceptions Hub',
    pricingMgmt: 'Pricing Matrix & Rebates',
    creditControl: 'Credit Control & Exposure',
    contractList: 'Sales Contracts & Blanket Orders',
    orderTracking: '13-Stage Order Tracking',
    ...
    crmDashboard: 'CRM Command Center',
    crmLeads: 'CRM Leads & Inquiries',
    crmLeadList: 'CRM Leads Directory',
    crmLeadDetail: `Lead: ${params?.leadId || 'Detail'}`,
    crmOpportunities: 'CRM Opportunities & Deals',
    crmOpportunityPipeline: 'CRM Pipeline & Deals',
    crmOpportunityDetail: `Opportunity: ${params?.oppId || 'Detail'}`,
    crmAccounts: 'CRM Customer Accounts',
    crmAccountList: 'CRM Accounts Directory',
    crmCustomer360: `Customer 360: ${params?.accountId || 'Account'}`,
    crmContacts: 'CRM Client Contacts',
    crmContactList: 'CRM Contacts Directory',
    crmFeedback: 'Customer Complaints & Claims',
    crmComplaintManagement: 'Customer Complaints & Claims (8D)',
    crmActivityManagement: 'CRM Activity Management',
    crmInquiryCosting: 'CRM Costing Modeler',
    crmQuotationManagement: 'CRM Quotation Management',
    crmSampleRequest: 'CRM Sample Trials',
    crmDocumentCenter: 'CRM Document Center',
    crmCustomerSegmentation: 'CRM Customer Segmentation & RFM',
    crmAnalyticsReports: 'CRM Analytics & Reports',
...
export const App: React.FC = () => {
  ...
  const getBreadcrumbs = (): string[] => {
    const map: Record<string, string[]> = {
      ...
      supplierInvoiceMatch: ['Procurement & Sourcing', '3-Way Match Supplier Invoices'],
      invoiceOcr: ['Procurement & Sourcing', 'AI OCR 3-Way Match Workspace'],
      invoiceOcrVerification: ['Procurement & Sourcing', 'AI OCR 3-Way Match Workspace'],
      ocrInvoiceMatcher: ['Procurement & Sourcing', 'AI OCR 3-Way Match Workspace'],
      threeWayMatch: ['Procurement & Sourcing', 'AI OCR 3-Way Match Workspace'],
